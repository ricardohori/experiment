...
$.jgrid = {
	...
	search : {
	    ...
	    Find: "Procurar",
	    Reset: "Limpar",
	    odata : ['Igual', 'Diferente', 'less', 'less or equal','greater','greater or equal', 'begins with','does not begin with','is in','is not in','ends with','does not end with','contains','does not contain'],
